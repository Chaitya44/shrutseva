      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-[28px] font-heading font-extrabold tracking-tight">
            <span className="text-[#012c77]">Missing</span><span className="text-[#FF6B00]"> Books</span>
          </h1>
          <span className="text-[11px] font-bold text-neutral-400 uppercase tracking-wide">Books reported missing or unaccounted</span>
        </div>
        <BhandarPageSelector />
      </div>
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="bg-gradient-to-r from-[#012c77] to-[#1D4ED8] text-white">
                ...
                <th className="px-5 py-3 font-bold text-left">Reported Date</th>
              </tr>
            </thead>
            <tbody>
              {data.map((row, i) => (
